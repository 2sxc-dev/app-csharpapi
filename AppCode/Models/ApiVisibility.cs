...
namespace AppCode.Models
{
  ...
  public class ApiVisibility: IVisibility
  {
    ...
    public bool ShowInDocs { get; internal set; } // => IsPublic && !HasPrivateApi && (HasPublicApi || HasInternalApi || HasWorkInProgressApi);
    ...
    public bool HasDocs { get; internal set; } // => HasPrivateApi || HasPublicApi || HasInternalApi || HasWorkInProgressApi;

    /// <summary>
    /// Summary for editor - either obsolete warning or hide attribute
    /// </summary>
    public bool EditorHideOrWarn { get; internal set; } // => HasEditorBrowsable || HasObsolete;
